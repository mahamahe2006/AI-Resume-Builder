  ...
  return (
   <div id='features' className='flex flex-col items-center my-10 scroll-mt-12'>
    ...
    <div className="flex items-center gap-2 text-sm text-green-800 bg-green-400/10  rounded-full px-6 py-1.5">
        ...
        <Title title='Build your resume' description='our streamlined process helps you create a proffessional resume in minutes with intelligent AI-powered tools and features.'/>
